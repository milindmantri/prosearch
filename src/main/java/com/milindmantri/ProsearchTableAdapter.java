 ...
 * ORM software. Created because TableAdapter is a final class and package private. This was
 * necessary as a part of jdbc store and engine
 */
final class ProsearchTableAdapter {

  private static final ProsearchTableAdapter DEFAULT = of("VARCHAR", "TIMESTAMP", "TEXT");

  // TODO: can get rid of stuff apart from postgres
  private static final Map<String, ProsearchTableAdapter> ADAPTERS =
      MapUtil.toMap(
  ...
  String serializableId(String id) {
    try {
      return StringUtil.truncateBytesWithHash(id, StandardCharsets.UTF_8, ID_MAX_LENGTH);
  ...
  ProsearchTableAdapter withIdType(String idType) {
    ...
    return new ProsearchTableAdapter(idType, modifiedType, jsonType);
  }
  ...
  static ProsearchTableAdapter of(String idType, String modifiedType, String jsonType) {
    return new ProsearchTableAdapter(idType, modifiedType, jsonType);
  }

  static ProsearchTableAdapter detect(String jdbcUrlOrDataSource) {
